...
goose -dir ./migrations postgres "user=$JARVIS_BOT_POSTGRES_USER password=$JARVIS_BOT_POSTGRES_PASSWORD dbname=$JARVIS_BOT_POSTGRES_DB host=$JARVIS_BOT_POSTGRES_HOST port=$JARVIS_BOT_POSTGRES_PORT sslmode=disable" up